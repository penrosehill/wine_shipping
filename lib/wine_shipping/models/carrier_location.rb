...
module WineShipping
  class CarrierLocation
    attr_accessor :is_alcohol_shipment_allowed
    ...
    def self.attribute_map
      {
        :'is_alcohol_shipment_allowed' => :'IsAlcoholShipmentAllowed',
    ...
    def self.openapi_types
      {
        :'is_alcohol_shipment_allowed' => :'Object',
        :'location_id' => :'Object',
        :'store_number' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WineShipping::CarrierLocation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WineShipping::CarrierLocation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'is_alcohol_shipment_allowed')
        self.is_alcohol_shipment_allowed = attributes[:'is_alcohol_shipment_allowed']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          is_alcohol_shipment_allowed == o.is_alcohol_shipment_allowed &&
    ...
    def hash
      [is_alcohol_shipment_allowed, location_id, store_number, location_type, address, business_hours].hash
    end
