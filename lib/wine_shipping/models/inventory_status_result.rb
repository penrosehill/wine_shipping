...
module WineShipping
  class InventoryStatusResult
    ...
    def self.swagger_types
      {
        ...
        :'warehouse_inventory_statuses' => :'Array<WarehouseInventoryStatus>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'WarehouseInventoryStatuses')
        if (value = attributes[:'WarehouseInventoryStatuses']).is_a?(Array)
