...
module WineShipping
  class InventoryStatusResult
    ...
    attr_accessor :warehouse_inventory_statuses
    ...
    def self.attribute_map
      {
        ...
        :'warehouse_inventory_statuses' => :'WarehouseInventoryStatuses'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'top' => :'Object',
        :'more_records' => :'Object',
        :'warehouse_inventory_statuses' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WineShipping::InventoryStatusResult` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WineShipping::InventoryStatusResult`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'warehouse_inventory_statuses')
        if (value = attributes[:'warehouse_inventory_statuses']).is_a?(Array)
          self.warehouse_inventory_statuses = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          warehouse_inventory_statuses == o.warehouse_inventory_statuses
    end
    ...
    def hash
      [total_record_count, skip, top, more_records, warehouse_inventory_statuses].hash
    end
