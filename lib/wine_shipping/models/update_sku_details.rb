...
module WineShipping
  class UpdateSKUDetails
    attr_accessor :authentication

    attr_accessor :requestor_info
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WineShipping::UpdateSKUDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WineShipping::UpdateSKUDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'requestor_info')
        self.requestor_info = attributes[:'requestor_info']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          requestor_info == o.requestor_info &&
          sku_info == o.sku_info
    end
    ...
    def hash
      [authentication, requestor_info, sku_info].hash
    end
