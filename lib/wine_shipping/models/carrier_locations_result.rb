...
module WineShipping
  class CarrierLocationsResult
    ...
    attr_accessor :carrier_locations
    ...
    def self.attribute_map
      {
        ...
        :'carrier_locations' => :'CarrierLocations'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WineShipping::CarrierLocationsResult` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WineShipping::CarrierLocationsResult`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'more_records')
        self.more_records = attributes[:'more_records']
      end

      if attributes.key?(:'carrier_locations')
        if (value = attributes[:'carrier_locations']).is_a?(Array)
          self.carrier_locations = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          carrier_locations == o.carrier_locations
    end
    ...
    def hash
      [transaction_reference_number, total_record_count, skip, top, more_records, carrier_locations].hash
    end
