...
module WineShipping
  class InventoryTransactionRequest
    ...
    attr_accessor :transaction_start_date_time

    attr_accessor :transaction_end_date_time
    ...
    def self.openapi_types
      {
        ...
        :'transaction_start_date_time' => :'Object',
        :'transaction_end_date_time' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WineShipping::InventoryTransactionRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WineShipping::InventoryTransactionRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'transaction_start_date_time')
        self.transaction_start_date_time = attributes[:'transaction_start_date_time']
      end

      if attributes.key?(:'transaction_end_date_time')
        self.transaction_end_date_time = attributes[:'transaction_end_date_time']
      end
      ...
      if attributes.key?(:'inventory_statuses')
        if (value = attributes[:'inventory_statuses']).is_a?(Array)
          self.inventory_statuses = value
        end
      end

      if attributes.key?(:'item_numbers')
        if (value = attributes[:'item_numbers']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transaction_start_date_time == o.transaction_start_date_time &&
          transaction_end_date_time == o.transaction_end_date_time &&
    ...
    def hash
      [authentication, transaction_date, transaction_start_date_time, transaction_end_date_time, transaction_type, transaction_types, warehouse, warehouses, reference, references, inventory_status, inventory_statuses, item_numbers, skip, top].hash
    end
