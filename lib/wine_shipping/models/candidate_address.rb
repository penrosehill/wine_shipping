...
module WineShipping
  class CandidateAddress
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AddressClassificationIndicator')
        self.address_classification_indicator = attributes[:'AddressClassificationIndicator']
      end

      if attributes.has_key?(:'CandidateAddressFormat')
        self.candidate_address_format = attributes[:'CandidateAddressFormat']
      end
    end
