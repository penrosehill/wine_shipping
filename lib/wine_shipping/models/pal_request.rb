...
module WineShipping
  class PALRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IncludePAL')
        self.include_pal = attributes[:'IncludePAL']
      end

      if attributes.has_key?(:'SearchRadius')
        self.search_radius = attributes[:'SearchRadius']
      end

      if attributes.has_key?(:'MaxPALListSize')
        self.max_pal_list_size = attributes[:'MaxPALListSize']
      end
    end
