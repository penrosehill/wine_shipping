...
module WineShipping
  class InventoryTransactionResult
    ...
    attr_accessor :inventory_transactions
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WineShipping::InventoryTransactionResult` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WineShipping::InventoryTransactionResult`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'inventory_transactions')
        if (value = attributes[:'inventory_transactions']).is_a?(Array)
          self.inventory_transactions = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          inventory_transactions == o.inventory_transactions
    end
    ...
    def hash
      [transaction_reference_number, total_record_count, skip, top, more_records, inventory_transactions].hash
    end
