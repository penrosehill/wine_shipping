...
module WineShipping
  class DeliveryEstimateResult
    ...
    attr_accessor :delivery_estimate_options
    ...
    def self.attribute_map
      {
        ...
        :'delivery_estimate_options' => :'DeliveryEstimateOptions'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'delivery_estimate_options' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WineShipping::DeliveryEstimateResult` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WineShipping::DeliveryEstimateResult`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'delivery_estimate_options')
        if (value = attributes[:'delivery_estimate_options']).is_a?(Array)
          self.delivery_estimate_options = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          delivery_estimate_options == o.delivery_estimate_options
    end
    ...
    def hash
      [transaction_reference_number, delivery_address, delivery_estimate_options].hash
    end
