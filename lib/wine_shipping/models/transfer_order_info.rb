...
module WineShipping
  class TransferOrderInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TransferFrom')
        self.transfer_from = attributes[:'TransferFrom']
      end

      if attributes.has_key?(:'TransferTo')
        self.transfer_to = attributes[:'TransferTo']
      end
    ...
    def hash
      [customer_reference_no, transfer_from, transfer_to, requested_date, inventory_status_code, special_instruction, first_name, last_name, email_address, phone_number].hash
    end
