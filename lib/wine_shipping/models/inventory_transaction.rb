  ...
  class InventoryTransaction
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WineShipping::InventoryTransaction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WineShipping::InventoryTransaction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'alcohol_percentage')
        self.alcohol_percentage = attributes[:'alcohol_percentage']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          alcohol_percentage == o.alcohol_percentage &&
    ...
    def hash
      [item_no, item_description, item_unit, alcohol_percentage, warehouse, inventory_status, transaction_date, transaction_date_time, transaction_type, reference, po_number, ship_to_name, order_type, quantity].hash
    end
