...
module WineShipping
  class AddressValidationClassificationResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AddressValidationIndicator')
        self.address_validation_indicator = attributes[:'AddressValidationIndicator']
      end
      ...
      if attributes.has_key?(:'AddressCandidates')
        if (value = attributes[:'AddressCandidates']).is_a?(Array)
