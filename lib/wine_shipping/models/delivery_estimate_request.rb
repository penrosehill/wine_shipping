...
module WineShipping
  class DeliveryEstimateRequest
    ...
    attr_accessor :delivery_estimate_range
    ...
    def self.attribute_map
      {
        ...
        :'delivery_estimate_range' => :'DeliveryEstimateRange'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'delivery_estimate_range' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WineShipping::DeliveryEstimateRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WineShipping::DeliveryEstimateRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'delivery_estimate_range')
        self.delivery_estimate_range = attributes[:'delivery_estimate_range']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          delivery_estimate_range == o.delivery_estimate_range
    end
    ...
    def hash
      [authentication, client_reference_code, delivery_address, delivery_estimate_range].hash
    end
