...
module WineShipping
  class ItemInfo
    ...
    attr_accessor :inventory_tax_status
    ...
    def self.attribute_map
      {
        ...
        :'inventory_tax_status' => :'InventoryTaxStatus',
        :'options' => :'Options'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WineShipping::ItemInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WineShipping::ItemInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'inventory_tax_status')
        self.inventory_tax_status = attributes[:'inventory_tax_status']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          inventory_tax_status == o.inventory_tax_status &&
          options == o.options
    end
    ...
    def hash
      [item_no, item_description, item_quantity, unit_price, quantity_unit, inventory_tax_status, options].hash
    end
