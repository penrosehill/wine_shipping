...
module WineShipping
  class AddressValidationClassificationRequest
    attr_accessor :authentication

    attr_accessor :client_reference_code
    ...
    def self.openapi_types
      {
        ...
        :'client_reference_code' => :'Object',
        :'shipping_carrier' => :'Object',
        :'address' => :'Object',
        :'pal_request' => :'Object',
        :'max_candidate_list_size' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WineShipping::AddressValidationClassificationRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WineShipping::AddressValidationClassificationRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'client_reference_code')
        self.client_reference_code = attributes[:'client_reference_code']
      end
      ...
      if attributes.key?(:'pal_request')
        self.pal_request = attributes[:'pal_request']
      end

      if attributes.key?(:'max_candidate_list_size')
        self.max_candidate_list_size = attributes[:'max_candidate_list_size']
      end
    end
