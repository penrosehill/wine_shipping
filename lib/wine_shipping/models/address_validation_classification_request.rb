...
module WineShipping
  class AddressValidationClassificationRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ClientReferenceCode')
        self.client_reference_code = attributes[:'ClientReferenceCode']
      end
      ...
      if attributes.has_key?(:'MaxCandidateListSize')
        self.max_candidate_list_size = attributes[:'MaxCandidateListSize']
      end
    end
