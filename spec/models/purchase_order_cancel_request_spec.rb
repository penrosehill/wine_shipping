...
# Unit tests for WineShipping::PurchaseOrderCancelRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseOrderCancelRequest' do
  before do
    # run before each test
    @instance = WineShipping::PurchaseOrderCancelRequest.new
  end
  ...
  describe 'test an instance of PurchaseOrderCancelRequest' do
    it 'should create an instance of PurchaseOrderCancelRequest' do
      expect(@instance).to be_instance_of(WineShipping::PurchaseOrderCancelRequest)
    end
  end
