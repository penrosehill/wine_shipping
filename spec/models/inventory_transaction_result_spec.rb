...
# Unit tests for WineShipping::InventoryTransactionResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InventoryTransactionResult' do
  before do
    # run before each test
    @instance = WineShipping::InventoryTransactionResult.new
  end
  ...
  describe 'test an instance of InventoryTransactionResult' do
    it 'should create an instance of InventoryTransactionResult' do
      expect(@instance).to be_instance_of(WineShipping::InventoryTransactionResult)
    end
  end
  ...
  describe 'test attribute "inventory_transactions"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
