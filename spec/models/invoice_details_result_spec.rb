...
# Unit tests for WineShipping::InvoiceDetailsResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceDetailsResult' do
  before do
    # run before each test
    @instance = WineShipping::InvoiceDetailsResult.new
  end
  ...
  describe 'test an instance of InvoiceDetailsResult' do
    it 'should create an instance of InvoiceDetailsResult' do
      expect(@instance).to be_instance_of(WineShipping::InvoiceDetailsResult)
    end
  end
