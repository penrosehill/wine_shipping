...
# Unit tests for WineShipping::CandidateAddressFormat
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CandidateAddressFormat' do
  before do
    # run before each test
    @instance = WineShipping::CandidateAddressFormat.new
  end
  ...
  describe 'test an instance of CandidateAddressFormat' do
    it 'should create an instance of CandidateAddressFormat' do
      expect(@instance).to be_instance_of(WineShipping::CandidateAddressFormat)
    end
  end
