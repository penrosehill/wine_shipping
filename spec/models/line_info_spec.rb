...
# Unit tests for WineShipping::LineInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LineInfo' do
  before do
    # run before each test
    @instance = WineShipping::LineInfo.new
  end
  ...
  describe 'test an instance of LineInfo' do
    it 'should create an instance of LineInfo' do
      expect(@instance).to be_instance_of(WineShipping::LineInfo)
    end
  end
