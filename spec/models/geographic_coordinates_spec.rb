...
# Unit tests for WineShipping::GeographicCoordinates
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GeographicCoordinates' do
  before do
    # run before each test
    @instance = WineShipping::GeographicCoordinates.new
  end
  ...
  describe 'test an instance of GeographicCoordinates' do
    it 'should create an instance of GeographicCoordinates' do
      expect(@instance).to be_instance_of(WineShipping::GeographicCoordinates)
    end
  end
