...
# Unit tests for WineShipping::OrderOnHoldItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderOnHoldItem' do
  before do
    # run before each test
    @instance = WineShipping::OrderOnHoldItem.new
  end
  ...
  describe 'test an instance of OrderOnHoldItem' do
    it 'should create an instance of OrderOnHoldItem' do
      expect(@instance).to be_instance_of(WineShipping::OrderOnHoldItem)
    end
  end
