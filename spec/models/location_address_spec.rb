...
# Unit tests for WineShipping::LocationAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LocationAddress' do
  before do
    # run before each test
    @instance = WineShipping::LocationAddress.new
  end
  ...
  describe 'test an instance of LocationAddress' do
    it 'should create an instance of LocationAddress' do
      expect(@instance).to be_instance_of(WineShipping::LocationAddress)
    end
  end
