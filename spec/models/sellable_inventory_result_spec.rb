...
# Unit tests for WineShipping::SellableInventoryResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SellableInventoryResult' do
  before do
    # run before each test
    @instance = WineShipping::SellableInventoryResult.new
  end
  ...
  describe 'test an instance of SellableInventoryResult' do
    it 'should create an instance of SellableInventoryResult' do
      expect(@instance).to be_instance_of(WineShipping::SellableInventoryResult)
    end
  end
