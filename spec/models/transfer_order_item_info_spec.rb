...
# Unit tests for WineShipping::TransferOrderItemInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferOrderItemInfo' do
  before do
    # run before each test
    @instance = WineShipping::TransferOrderItemInfo.new
  end
  ...
  describe 'test an instance of TransferOrderItemInfo' do
    it 'should create an instance of TransferOrderItemInfo' do
      expect(@instance).to be_instance_of(WineShipping::TransferOrderItemInfo)
    end
  end
