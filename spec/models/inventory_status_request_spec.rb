...
# Unit tests for WineShipping::InventoryStatusRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InventoryStatusRequest' do
  before do
    # run before each test
    @instance = WineShipping::InventoryStatusRequest.new
  end
  ...
  describe 'test an instance of InventoryStatusRequest' do
    it 'should create an instance of InventoryStatusRequest' do
      expect(@instance).to be_instance_of(WineShipping::InventoryStatusRequest)
    end
  end
