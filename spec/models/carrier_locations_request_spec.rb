...
# Unit tests for WineShipping::CarrierLocationsRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CarrierLocationsRequest' do
  before do
    # run before each test
    @instance = WineShipping::CarrierLocationsRequest.new
  end
  ...
  describe 'test an instance of CarrierLocationsRequest' do
    it 'should create an instance of CarrierLocationsRequest' do
      expect(@instance).to be_instance_of(WineShipping::CarrierLocationsRequest)
    end
  end
