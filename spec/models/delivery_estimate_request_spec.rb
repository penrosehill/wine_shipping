...
# Unit tests for WineShipping::DeliveryEstimateRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeliveryEstimateRequest' do
  before do
    # run before each test
    @instance = WineShipping::DeliveryEstimateRequest.new
  end
  ...
  describe 'test an instance of DeliveryEstimateRequest' do
    it 'should create an instance of DeliveryEstimateRequest' do
      expect(@instance).to be_instance_of(WineShipping::DeliveryEstimateRequest)
    end
  end
  ...
  describe 'test attribute "delivery_estimate_range"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
