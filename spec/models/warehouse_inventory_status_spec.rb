...
# Unit tests for WineShipping::WarehouseInventoryStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WarehouseInventoryStatus' do
  before do
    # run before each test
    @instance = WineShipping::WarehouseInventoryStatus.new
  end
  ...
  describe 'test an instance of WarehouseInventoryStatus' do
    it 'should create an instance of WarehouseInventoryStatus' do
      expect(@instance).to be_instance_of(WineShipping::WarehouseInventoryStatus)
    end
  end
