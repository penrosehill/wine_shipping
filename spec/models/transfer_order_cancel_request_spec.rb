...
# Unit tests for WineShipping::TransferOrderCancelRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferOrderCancelRequest' do
  before do
    # run before each test
    @instance = WineShipping::TransferOrderCancelRequest.new
  end
  ...
  describe 'test an instance of TransferOrderCancelRequest' do
    it 'should create an instance of TransferOrderCancelRequest' do
      expect(@instance).to be_instance_of(WineShipping::TransferOrderCancelRequest)
    end
  end
