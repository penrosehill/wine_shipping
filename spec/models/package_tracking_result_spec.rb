...
# Unit tests for WineShipping::PackageTrackingResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageTrackingResult' do
  before do
    # run before each test
    @instance = WineShipping::PackageTrackingResult.new
  end
  ...
  describe 'test an instance of PackageTrackingResult' do
    it 'should create an instance of PackageTrackingResult' do
      expect(@instance).to be_instance_of(WineShipping::PackageTrackingResult)
    end
  end
