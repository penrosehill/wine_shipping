...
# Unit tests for WineShipping::UpdateSKUInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateSKUInfo' do
  before do
    # run before each test
    @instance = WineShipping::UpdateSKUInfo.new
  end
  ...
  describe 'test an instance of UpdateSKUInfo' do
    it 'should create an instance of UpdateSKUInfo' do
      expect(@instance).to be_instance_of(WineShipping::UpdateSKUInfo)
    end
  end
