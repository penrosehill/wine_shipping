...
# Unit tests for WineShipping::InvoiceDetailsRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceDetailsRequest' do
  before do
    # run before each test
    @instance = WineShipping::InvoiceDetailsRequest.new
  end
  ...
  describe 'test an instance of InvoiceDetailsRequest' do
    it 'should create an instance of InvoiceDetailsRequest' do
      expect(@instance).to be_instance_of(WineShipping::InvoiceDetailsRequest)
    end
  end
