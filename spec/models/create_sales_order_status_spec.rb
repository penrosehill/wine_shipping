...
# Unit tests for WineShipping::CreateSalesOrderStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSalesOrderStatus' do
  before do
    # run before each test
    @instance = WineShipping::CreateSalesOrderStatus.new
  end
  ...
  describe 'test an instance of CreateSalesOrderStatus' do
    it 'should create an instance of CreateSalesOrderStatus' do
      expect(@instance).to be_instance_of(WineShipping::CreateSalesOrderStatus)
    end
  end
  ...
  describe 'test attribute "ref_transmission_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "ref_order_no"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
