...
# Unit tests for WineShipping::Personalization
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Personalization' do
  before do
    # run before each test
    @instance = WineShipping::Personalization.new
  end
  ...
  describe 'test an instance of Personalization' do
    it 'should create an instance of Personalization' do
      expect(@instance).to be_instance_of(WineShipping::Personalization)
    end
  end
