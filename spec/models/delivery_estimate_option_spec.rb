...
# Unit tests for WineShipping::DeliveryEstimateOption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeliveryEstimateOption' do
  before do
    # run before each test
    @instance = WineShipping::DeliveryEstimateOption.new
  end
  ...
  describe 'test an instance of DeliveryEstimateOption' do
    it 'should create an instance of DeliveryEstimateOption' do
      expect(@instance).to be_instance_of(WineShipping::DeliveryEstimateOption)
    end
  end
  describe 'test attribute "delivery_date_estimate"' do
    it 'should work' do
