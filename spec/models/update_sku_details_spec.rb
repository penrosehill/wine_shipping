...
# Unit tests for WineShipping::UpdateSKUDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateSKUDetails' do
  before do
    # run before each test
    @instance = WineShipping::UpdateSKUDetails.new
  end
  ...
  describe 'test an instance of UpdateSKUDetails' do
    it 'should create an instance of UpdateSKUDetails' do
      expect(@instance).to be_instance_of(WineShipping::UpdateSKUDetails)
    end
  end
